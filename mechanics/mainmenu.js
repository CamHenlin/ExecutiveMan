...
function initMainMenuScreen() {
	...
	var newGameLabel = new createjs.Text("NEW GAME", "bold 14px Arial", "#FFF");
	...
	var loadGameLabel = new createjs.Text("LOAD GAME", "bold 14px Arial", "#FFF");
	...
	var optionsMenuLabel = new createjs.Text("OPTIONS", "bold 14px Arial", "#FFF");
